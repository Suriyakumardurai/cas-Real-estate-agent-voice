...
def generate_twiml(host: str, body_data: dict = None) -> str:
    ...
    # --- START OF FIX ---
    # We remove ALL <Say> and <Play> verbs from the TwiML.
    # We want to connect to the WebSocket IMMEDIATELY.
    # The bot itself will handle the waiting music.
    # --- END OF FIX ---
    ...
    # Fallback pause in case <Connect> fails immediately
...
async def start_call(request: Request):
    ...
    # Log the TwiML and WebSocket URL for debugging
    websocket_url = get_websocket_url(host)
